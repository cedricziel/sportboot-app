...
void main() {
  ...
  group('MigrationService Tests', () {
    ...
    test('migrateDataIfNeeded should skip migration when database is populated', () async {
    ...
    test('migrateDataIfNeeded should perform migration when database is empty', () async {
    ...
    test('migration progress callbacks should be called in order', () async {
      ...
      expect(statusMessages.first, anyOf(
        contains('Starting'),
