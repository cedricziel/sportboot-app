...
void main() {
  ...
  group('NotificationService', () {
    ...
    test('should update notification time in storage when notifications enabled', () async {
    ...
    test('notification methods should complete without throwing errors', () async {
    ...
    test('should update interaction count persistently', () async {
      ...
      final savedCount = storageService.getSetting('notificationInteractions', defaultValue: 0);
