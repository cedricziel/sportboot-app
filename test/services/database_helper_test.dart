...
void main() {
  group('DatabaseHelper Tests', () {
    ...
    test('isDatabasePopulated should return false for empty database', () async {
      await databaseHelper.clearDatabase();
      final isPopulated = await databaseHelper.isDatabasePopulated();
      expect(isPopulated, false);
    });

    test('isDatabasePopulated should return true after adding questions', () async {
      final db = await databaseHelper.database;
    ...
    test('clearDatabase should remove all data', () async {
      ...
      final questionsResult = await db.rawQuery('SELECT COUNT(*) as count FROM questions');
      final questionsCount = questionsResult.first['count'] as int;
      
      final bookmarksResult = await db.rawQuery('SELECT COUNT(*) as count FROM bookmarks');
