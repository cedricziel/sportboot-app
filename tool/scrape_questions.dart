...
class QuestionScraper {
  ...
  Future<void> run() async {
    ...
    print('📚 Found ${catalogs.length} catalogs and ${courses.length} courses\n');
  ...
  List<Question> parseQuestions(Document document, String category) {
    ...
    for (int i = 0; i < paragraphs.length; i++) {
      ...
      if (answerList == null) {
        ...
        while (sibling != null && sibling.localName != 'ol' && sibling.localName != 'p') {
  ...
  Future<void> generateCourseFiles(
    ...
    await outputFile.writeAsString(buffer.toString());
    print('   ✓ Saved ${allQuestions.length} questions to ${outputFile.path}\n');
  }
}
